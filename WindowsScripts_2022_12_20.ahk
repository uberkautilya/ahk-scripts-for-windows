...
#i::
    {
        SetTitleMatchMode, 2
        IfWinExist,Intellij_workspace
        {
            ifWinActive
            {
                WinActivatebottom,Intellij_workspace
            }
            else
            {
                WinActivate
        ...
        {
            Run "C:\Users\Mithun\IdeaProjects\AHK_Project"
        }
        keysUp()
        return
    }
...
!#c::
    {
        ...
        else
        {
            ...
            Run "C:\Users\mithu\AppData\Local\Programs\Microsoft VS Code\Code.exe"
        }
        keysUp()
        return
    }
...
!#n::
    {
        ...
        {
            Run, "C:\Users\mithu\AppData\Local\Programs\Notion\Notion.exe"
        }
        keysUp()
        return
    }
!#i::
    {
        ...
        {
            Run, "C:\Program Files\JetBrains\IntelliJ IDEA Community Edition 2022.1.3\bin\idea64.exe"
        }
        keysUp()
        return
    }
!#k::
    {
        SetTitleMatchMode, 2
        IfWinExist,ahk_exe KMPlayer64.exe,
        {
            ifWinActive
            {
                WinActivatebottom,ahk_exe KMPlayer64.exe
            }
            else
            {
                WinActivate
        ...
        {
            Run, "C:\Program Files\KMPlayer 64X\KMPlayer64.exe"
        }
        keysUp()
        return
    }
...
^+v::
    ...
    ^F1::
        ...
        *F1 Up::ToolTip, % KeyCombination(), 1000, 15
        !F2::
            {
                Loop, 0xFF
                    IF GetKeyState(Key:=Format("VK{:X}",A_Index))
